    ...
    return (
        <>
            <div className="flex h-screen">
                <div className="w-full lg:w-4 h-full text-center px-6 py-6 flex flex-column justify-content-between">
                    ...
                    <div className="flex flex-column align-items-center gap-4">
                        ...
                        <div className="flex flex-column gap-4">
                            ...
                            <Button label="SIGN UP" className="w-full mb-4" style={{ backgroundColor: '#7EE288' }} onClick={() => router.push('/auth/mfa')}></Button>
                ...
                <div className="w-7 hidden lg:flex flex-column justify-content-between align-items-center px-4 py-4 bg-center bg-no-repeat" style={{ backgroundImage: "url('/demo/images/auth/create.svg')" }}>
