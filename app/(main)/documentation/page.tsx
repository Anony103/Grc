  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <link
          id="theme-link"
          href={\`/theme/theme-dim/blue/theme.css\`}
          rel="stylesheet"
        ></link>
      </head>
      <body>
...
export const LayoutProvider = (props) => {
    ...
    const [layoutConfig, setLayoutConfig] = useState({
        ...
        colorScheme: 'dim',               //color scheme of the template, valid values are "light", "nd "dark"
    ...
    const model = [
        {
            ...
            <p>
                ...
                folder such as <span className="text-primary font-medium">public/theme/theme-dim/blue/theme.css</span>.
            </p>
            ...
            <ul>
                ...
                <li className="line-height-4">
                    Create a folder named &ldquo;mytheme&ldquo; under <span className="font-semibold">theme/theme-dim/</span> folder.
                </li>
