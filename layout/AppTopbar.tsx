        ...
        <div className="layout-topbar">
            <div className="topbar-left">
                ...
                {/* <Link href="/" className="horizontal-logo">
                    <img id="logo-horizontal" src={`/layout/images/logo-${layoutConfig.menuTheme === 'dim' || layoutConfig.menuTheme === 'orange' ? 'dark' : 'dim'}.png`} alt="diamond-layout" />
                </Link> */}

                <span className="topbar-separator"></span>

                <AppBreadCrumb />
                {/* <img id="logo-mobile" className="mobile-logo" src={`/layout/images/logo-${layoutConfig.colorScheme == 'dim' ? 'dark' : 'dim'}.png`} alt="diamond-layout" /> */}
            </div>
                        ...
                        <ul className="list-none p-3 m-0 border-round shadow-2 absolute surface-overlay hidden origin-top w-full sm:w-19rem mt-2 right-0 z-5 top-auto">
                            <li>
                                <a className="p-ripple flex p-2 border-round align-items-center hover:surface-hover transition-colors transition-duration-150 cursor-pointer">
                                    <i className="pi pi-bell mr-3"></i>
                                    <span className="flex flex-column">
                                        <span className="font-semibold">New Risk</span>
                                        <span className="text-color-secondary">
                                            You have <strong>1</strong> new risk.
                                        </span>
                                    </span>
                                    <Ripple />
                                </a>
